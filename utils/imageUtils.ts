...
export const getHighQualityBase64 = (file: File): Promise<string> => {
  return new Promise((resolve, reject) => {
      ...
      reader.onload = (event) => {
          ...
          img.onload = () => {
              ...
              // Max width 1600px for better AI OCR
              const maxWidth = 1600;
              let width = img.width;
              ...
              // Compress to JPEG at 0.9 quality (High quality)
              const hqBase64 = canvas.toDataURL('image/jpeg', 0.9);
              resolve(hqBase64);
          };
